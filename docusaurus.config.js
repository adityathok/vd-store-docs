...
const config = {
  ...
  url: 'https://kerjaan3.velocitydeveloper.com',
  ...
  organizationName: 'velocitydeveloper', // Usually your GitHub org/user name.
  projectName: 'vd-store', // Usually your repo name.
